...
object FormatDefinitions {
    ...
    private fun domiciliacionPendiente(tipo: String, description: String) = FormatSpec(
        tipo = tipo,
        description = description,
        expectedLength = 37,
        tipoFieldStart = 1,
    ...
    private fun tributarioPeriodo(tipo: String, description: String) = FormatSpec(
        tipo = tipo,
        description = description,
        expectedLength = 39,
        tipoFieldStart = 15,
    ...
    private fun declaracionAeat(tipo: String, description: String) = FormatSpec(
        tipo = tipo,
        description = description,
        expectedLength = 36,
        tipoFieldStart = 1,
    ...
    val all: List<FormatSpec> = listOf(
        // Appendix A
        TIPO_504, TIPO_501, TIPO_502, TIPO_503, TIPO_508,
        TIPO_521, TIPO_522, TIPO_523,
        TIPO_507, TIPO_514, TIPO_515, TIPO_524, TIPO_525, TIPO_528, TIPO_529, TIPO_579, TIPO_580, TIPO_581, TIPO_582, TIPO_583, TIPO_584, TIPO_585,
        // Appendix B ventanilla
        TIPO_518, TIPO_526, TIPO_527, TIPO_534, TIPO_535, TIPO_564, TIPO_565,
        // Appendix B/C periodo
        TIPO_539, TIPO_550, TIPO_551, TIPO_559,
        // Appendix C declaraciones
        TIPO_512, TIPO_530, TIPO_532, TIPO_533, TIPO_558,
        // AEAT / Comunidades Autónomas
        TIPO_010, TIPO_011, TIPO_013, TIPO_016, TIPO_017,
        // Lotería Catalunya
        TIPO_571, TIPO_572, TIPO_573,
        // Loterías
        TIPO_586,
        // ONCE
        TIPO_531, TIPO_587, TIPO_588, TIPO_589, TIPO_590, TIPO_591,
        // Entidades depositarias
        TIPO_020,
        // Seguridad Social adicionales
        TIPO_592
